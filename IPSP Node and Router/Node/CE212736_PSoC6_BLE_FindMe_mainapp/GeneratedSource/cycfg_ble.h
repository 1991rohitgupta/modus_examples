...
#define CY_BLE_GATT_DB_ATT_VAL_COUNT                (0x18u)
...
#define CY_BLE_ADV_PKT_0_INDEXSERVICE_UUID_16   (0x0Du)
#define CY_BLE_SCN_PKT_0_INDEXLOCAL_NAME   (0x00u)
#define CY_BLE_SCN_PKT_0_INDEXTX_POWER_LEVEL   (0x0Au)
#define CY_BLE_SCN_PKT_0_INDEXAPPEARANCE   (0x0Du)
...
<Configuration major="1" minor="1" device="PSoC6">
                ...
                <ProfileRole type="Server">
                    ...
                    <Services>
                                    ...
                                    <Fields>
                                        <Field>
                                            <FieldProperties>
                                                ...
                                                <Property id="Value" value="BLE Node"/>
                        ...
                        <Service type="org.bluetooth.service.internet_protocol_support">
                            <ServiceProperties>
                                <Property id="EntityID" value="{356babe7-d53c-4f96-b80a-e03c7fe9569c}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics/>
                        </Service>
    ...
    <GAP>
        <General>
            ...
            <Property id="DeviceName" value="BLE Node"/>
        ...
        <PeripheralConfigurations>
            <PeripheralConfiguration name="Peripheral configuration 0">
                <AdvertisementProperties>
                    ...
                    <Property id="AdvFastTimeout" value="180"/>
                ...
                <AdvertisementPacket>
                    ...
                    <Property id="ServiceUuid" value="{542b9767-26d8-4b73-bb59-ef2ff4505ea7}, {356babe7-d53c-4f96-b80a-e03c7fe9569c}"/>
                </AdvertisementPacket>
                <ScanResponsePacket>
                    <Property id="AdLocalName" value="true"/>
                    <Property id="LocalNameType" value="Complete"/>
