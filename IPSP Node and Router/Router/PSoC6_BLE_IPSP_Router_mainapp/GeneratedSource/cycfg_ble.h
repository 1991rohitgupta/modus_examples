...
#define CY_BLE_GATT_DB_MAX_VALUE_LEN                (0x000Bu)
...
#define CY_BLE_GATT_DB_ATT_VAL_COUNT                (0x1Bu)
...
/** L2CAP MTU Size */
#define CY_BLE_CONFIG_L2CAP_MTU                     (0x500u)
...
#define CY_BLE_CONFIG_MAX_WHITE_LIST_SIZE           (0x08u)
...
<Configuration major="1" minor="1" device="PSoC6">
            ...
            <ProfileRoles>
                                    ...
                                    <Fields>
                                        <Field>
                                            <FieldProperties>
                                                ...
                                                <Property id="Value" value="IPSP Router"/>
                ...
                <ProfileRole type="Client">
                    ...
                    <Services>
                        <Service type="org.bluetooth.service.generic_access">
                            <ServiceProperties>
                                <Property id="EntityID" value="{b1b5b055-1b5d-4c9e-bcbf-729e29efc686}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics>
                                <Characteristic type="org.bluetooth.characteristic.gap.device_name">
                        ...
                        <Service type="org.bluetooth.service.generic_attribute">
                            <ServiceProperties>
                                <Property id="EntityID" value="{12cae7ab-2edc-47b3-abe8-dbcd3c2cd71e}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics/>
                        </Service>
                        <Service type="org.bluetooth.service.internet_protocol_support">
                            <ServiceProperties>
                                <Property id="EntityID" value="{60fdd181-65e7-43c4-83b3-d1fd19e192fa}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics/>
                        </Service>
    ...
    <GAP>
        <General>
            ...
            <Property id="DeviceName" value="IPSP Router"/>
            <Property id="Appearance" value="0"/>
            <Property id="TxPowerLevelAdvScan" value="Pos_0"/>
            <Property id="TxPowerLevelConnection" value="Pos_0"/>
            <Property id="BondListSize" value="4"/>
        </General>
        <CentralConfigurations>
            <CentralConfiguration name="Central configuration 0">
                <ScanProperties>
                    <Property id="ScanDiscoveryProcedure" value="Limited"/>
                    <Property id="ScanningState" value="Active"/>
                    <Property id="ScanFilterPolicy" value="AcceptAllAdvPackets"/>
                    <Property id="DuplicateFiltering" value="true"/>
                    <Property id="ScanFastWindow" value="30"/>
                    <Property id="ScanFastInterval" value="30"/>
                    <Property id="ScanFastTimeoutEnabled" value="true"/>
                    <Property id="ScanFastTimeout" value="180"/>
                    <Property id="EnableReducedScan" value="false"/>
                </ScanProperties>
                <ConnectionProperties>
                    <Property id="ConnectionIntervalMinEnabled" value="true"/>
                    <Property id="ConnectionIntervalMin" value="7.5"/>
                    <Property id="ConnectionIntervalMaxEnabled" value="true"/>
                    <Property id="ConnectionIntervalMax" value="50"/>
                    <Property id="ConnectionSlaveLatency" value="0"/>
                    <Property id="ConnectionTimeoutEnabled" value="true"/>
                    <Property id="ConnectionTimeout" value="10000"/>
                </ConnectionProperties>
    ...
    <L2capProperties>
        ...
        <Property id="L2capMtuSize" value="1280"/>
    </L2capProperties>
    <LinkLayerProperties>
        <Property id="MaxTxPayloadSize" value="27"/>
        <Property id="MaxRxPayloadSize" value="27"/>
        <Property id="MaxWhitelistSize" value="8"/>
        <Property id="EnableLLPrivacy" value="false"/>
