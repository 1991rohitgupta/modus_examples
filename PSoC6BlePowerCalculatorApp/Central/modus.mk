...
CY_MAINAPP_SWCOMP_USED= \
    psoc6sw-1.2/components/psoc6pdl/devices/psoc6/cm0p/prebuilt \
    psoc6sw-1.2/components/psoc6mw/ble/config/single_cm4_softfp \
    psoc6sw-1.2/components/psoc6pdl/utilities/retarget_io/user \
    psoc6sw-1.2/components/psoc6mw/ble/config/base \
    psoc6sw-1.2/components/psoc6pdl/utilities/retarget_io
#
